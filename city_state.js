...
city_states['Armenia'] = '|Yerevan||Aragatsotn|Ararat|Armavir|Gegharkunik|Kotayk|Lorri|Shirak|Tavush|Vayots Dzor';
...
city_states['Saudi Arabia'] = '|Riyadh||Al Bahah|Al Hudud ash Shamaliyah|Al Jawf|Al Madinah|Al Qasim|Ar Riyad|Ash Sharqiyah (Eastern Province)|Jizan|Makkah|Najran|Tabuk';
city_states['Syria'] = '|Damascus||Al Hasakah|Al Ladhiqiyah|Al Qunaytirah|Ar Raqqah|As Suwayda|Dayr az Zawr|Dimashq|Halab|Hamah|Hims|Idlib|Rif Dimashq|Tartus';
...
city_states['United Arab Emirates'] = '|Abu Dhabi||Abu Zaby (Abu Dhabi)|Ajman|Al Fujayrah|Ash Shariqah (Sharjah)|Dubayy (Dubai)|Umm al Qaywayn';
city_states['Uzbekistan'] = '|Tashkent (Toshkent)||Andijon Viloyati|Buxoro Viloyati|Farg|Jizzax Viloyati|Namangan Viloyati|Navoiy Viloyati|Qashqadaryo Viloyati (Qarshi)|Qaraqalpog|Samarqand Viloyati|Sirdaryo Viloyati (Guliston)|Surxondaryo Viloyati (Termiz)|Toshkent Shahri|Toshkent Viloyati|Xorazm Viloyati (Urganch)';
city_states['Yemen'] = '|Sanaa||Abyan||Al Hudaydah|Al Jawf|Al Mahrah|Al Mahwit|Dhamar|Hadramawt|Hajjah|Ibb|Lahij|Ma|Shabwah|Ta';
...
function set_city_state(oCountrySel, oCity_StateSel)
{
	...
	if (city_states[country])
	{
		...
		console.log("document.getElementById('txtplacename').innerHTML = country");
	}
...
function print_city_state(oCountrySel, oCity_StateSel)
{
	...
	if (city_state && city_states[country].indexOf(city_state) != -1)
		console.log("document.getElementById('txtplacename').innerHTML = city_state + ', ' + country");
	else
	console.log("document.getElementById('txtplacename').innerHTML = country");
}